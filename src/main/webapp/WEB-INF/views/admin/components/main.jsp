        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <img class="card-img-top" src="${pageContext.request.contextPath}/resources/img/glassType1.jpg"
                             alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><spring:message
                                    code="message.enum.componentType.glassType.plural"/></h4>
                            <p class="card-text"><spring:message code="message.component.section.glassType.text"/></p>
